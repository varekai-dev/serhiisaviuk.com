...
export const portfolio = [
    {
        ...
        description:
            'Веб-сайт замовлення піци з адмін панеллю. Є можливість замовлення піци, перегляду замовлень, додавання нових піц. Є можливість вибору розміру, та додаткових інгредієнтів. З інтеграцій: Stripe, Google Maps API, nodemailer',
        technologies: [
            'next',
            'mongodb',
            'prisma',
...
export const now = {
    ...
    description:
        'Працював над різними проектами. Моя сфера діяльності: перегляд коду, написання коду, тестування, рефакторинг, виправлення помилок, реалізація нових функцій',
    scope: [
        'redux',
        'react',
        'unit testing',
...
export const backThen = [
    {
        ...
        place: 'Frontend developer в G-Light Technology',
        work: 'Працював над різними лендінг сторінками рекламних акцій, веб-сайтом компанії, програмою лояльності для клієнтів та сайтом новин кіберспорту.',
        scope: [
            'верстка лендінгів',
            'розробка функціоналу',
            'розробка сайтів на next.js',
            'підтримка адмінки на strapi',
        ],
        id: uuid(),
    },
    {
