...
export const realProjects = [
  {
    ...
    description:
      "Conexwest є провідним постачальником стандартних та модифікованих контейнерів для зберігання в Північній Каліфорнії. Адмін панель над тим, чим я працюю, створена для управління роботою ресурсів, контролю завдань та створення звітів.",
    technologies: [
      "react",
      "redux",
      "redux-saga",
