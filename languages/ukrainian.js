...
export const portfolio = [
	{
		...
		apiko: true,
		description: "Веб-сайт з коктейлями, який використовує безкоштовний API TheCockTailDB для передачі даних. Є кошик для замовлень. Все виконано у сучасному дизайні. Присутній алкометр для достатнього сп'яніння😋",
		technologies: ['react', 'react-router-dom', 'hooks', 'skeleto-react', 'tostify', 'rest-api', 'classnames', 'node-sass'],
		id: uuid()
	},
	{
		name: 'MultiStep Form',
...
export const realProjects = [
	{
		...
		description: 'Окремий веб-сайт, який підключений до основного, де користувач може зареєструватися, увійти. Обліковий запис збирає всю історію користувача, центр сповіщень, магазин з різними плюшками, які користувач може придбати за свою лояльність',
...

	{
		...
		scope: ['Створення HTML зі стилями для 30 сторінок', ' Тестування функціональності вебсайту', ' Створення блогу ', ' Створення віджета з матчами які будуть йти, та їх рахунками'],
		id: uuid()
	},
	{
		website: 'NDA',
		...
		description: 'Створив близько 100+ лендінгів. В основному для маркетингових цілей',
		technologies: ['nextjs', 'html', 'css', 'javascript', 'jquery', 'scss', 'gulp', 'figma', 'photoshop', 'wordpress', 'elementor', 'digitalocean'],
		scope: ['Створення адаптивного коду', 'Оптимізація сторінок', 'Написання HTML, CSS, JS'],
		id: uuid()
	}
];
...
export const now = {
	...
	scope: ['емейл маркетинг', 'маркетинг', 'верстка лендінгів', 'розробка сайтів на next.js', 'дизайн', 'аналітика', 'cмм', 'підтримка'],
	id: uuid()
};
...
export const character = ['ВІДПОВІДАЛЬНИЙ ', ' ПРОДУКТИВНИЙ ', 'ДИСЦИПЛІНОВАНИЙ', 'АНАЛІТЧИНЙ', ' САМОКРИТИЧНИЙ ', 'ІНІЦІАТИВНИЙ', 'ПУНКТУАЛЬНИЙ', 'З ПОЧУТТЯМ ГУМОРУ'];
