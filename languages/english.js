...
export const portfolio = [
	{
		...
		apiko: true,
		description: "A website with cocktails that uses free API TheCockTailDB for data. It is made with a cart for orders with modern design. There is alcotester, so you won't miss drunk status😋",
		technologies: ['react', 'react-router-dom', 'hooks', 'skeleton-react', 'tostify', 'rest-api', 'classnames', 'node-sass'],
		id: uuid()
	},
	{
		name: 'MultiStep Form',
...
export const realProjects = [
	...
	},
	{
		...
		technologies: ['nextjs', 'html', 'css', 'javascript', 'jquery', 'scss', 'gulp', 'figma', 'photoshop', 'wordpress', 'elementor', 'digitalocean'],
		scope: ['Making responsive code', 'Making page speed optimization', 'Writing HTML, CSS, JS'],
		id: uuid()
	}
];
...
export const now = {
	...
	scope: ['Email marketing', 'marketing', 'developing frontend pages', 'design', 'analytics', 'smm', 'supporting'],
	id: uuid()
};
...
export const character = ['PRODUCTIVE', 'DISCIPLINED', 'ACCURATE', 'ANALYTICAL', 'RESPONSIBLE', 'SELF-CRITICAL', 'INITIATIVE', 'PUNCTUAL', 'WITH A SENSE OF HUMOR'];
