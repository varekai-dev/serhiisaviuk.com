...
export const portfolio = [
  {
    ...
    apiko: true,
    description:
      "Website with coctails that uses free api TheCockTailDB for data. It is made with cart for orders with modern design",
    technologies: [
      "react",
      "react-router-dom",
      "hooks",
  ...
  },
  {
    ...
    description:
      "Multi step registration form from figma design that uses switch to change steps and collect all data in context to send it after form has been submitted",
...

  {
    ...
    apiko: true,
    description:
      "Simple website with two pages that get movies from database. Got pagination, rating popup and routes",
    technologies: [
      "react",
      "react-router-dom",
      "hooks",
  ...
  },
  {
    ...
    description:
      "Copy of Netflix website with registration and login form. Simple website with movie api to see what is in trends.",
  ...
  },
  {
    ...
    description:
      "Affiliate website to compare different casinos and bookies. Got ratings, blog, skeleton loading, breadcrumbs",
    technologies: [
      "nextjs",
      "strapi",
      "mongoDB",
  ...
  },
  {
    ...
    description: "Simple shop with cart that uses Fortnite api",
...
export const realProjects = [
  ...
  },
  {
    ...
    name: "User account",
    description:
      "Separate website that is connected to main where user can register, login. Account collect whole data order history, notification center, shop with diffrent items that user can get for his loyalty",
    technologies: [
      "nextjs",
      "strapi",
      "useSWR",
