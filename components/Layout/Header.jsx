    ...
    <header className="header">
      ...
      <div className="header__info">
        <div className="header__links">
          <h1 className="header__name">Serhii Saviuk</h1>
        ...
        <div className="header__about">
          <h2>Resume</h2>
          <p>
            — Hello! I am a newbie in the frontend, however, I have a passion to
            work with HTML, CSS, and JS. I love to create something new that
            will work after)
          </p>
        </div>
      </div>
